...
<html>
	<head>
		<title><s:property value="%{getText('login.jsp.huanyingdenglu')}"/><s:property value="%{getText('login.jsp.system.name')}"/></title>
		<link rel="stylesheet" type="text/css"  href="<%=request.getContextPath()%>/mobile/style.css"/>
	</head>
	<body>

		<font color='green'><b><s:property value="%{getText('login.jsp.system.name')}"/></b></font>
		<br/>
