...
<title><%=com.htsoft.core.util.AppUtil.getCompanyName()%>－－<s:property value="%{getText('login.jsp.system.name')}"/></title>
...
<body>
	...
	<form action="<%=request.getContextPath()%>/mobile/signIn.do" method="post">
		<table cellspacing="1" cellpadding="0" border="0" class="info">
			<thead>
			<tr>
				<td colspan="2"><s:property value="%{getText('login.jsp.huanyingdenglu')}"/><s:property value="%{getText('login.jsp.system.name')}"/></td>
			</tr>
			</thead>
			<tr>
				<td>用户名:</td>
