...
//				        YXtask.getCur.getCusPara__).result;
	...
	<body oncontextmenu="return false">
		...
		<div id="app-header" style="background: url('images/feiyuebannerbg.png') repeat-x scroll 0 0 transparent;height: 70px;left: 0;position: absolute;top: 0;width: 100%;">
			<div id="header-left">
				<!-- <img id ="CompanyLogo" src="<%=basePath + AppUtil.getCompanyLogo()%>" height="50" style="max-width:230px;"/> -->
				<img id="CompanyLogo" src="images/feiyuebanner.png" />
			</div>
			<div>
				<div>
