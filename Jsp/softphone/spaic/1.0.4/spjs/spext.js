...
//	alert(e);
	...
	//报工号
	/*
	setEduValue("vdutype","gonghao");//设置随路数据
	setEduValue("AgentNO",filterGetNumber(softphone_init_agentLoginID));//设置随路数据
	real_transfer_number = '4494';//会议报工号VDN号码	4494
	document.getElementById("text_transfer_number").value = real_transfer_number;	
	img1008.click();
	*/
}
