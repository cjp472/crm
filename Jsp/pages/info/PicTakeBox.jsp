...
<html>
  <head>
    ...
    <title>My JSP 'PicTakeBox.jsp' starting page</title>
	...
	-->
	<link rel="stylesheet" href="<%=basePath%>/jquery.Jcrop.css">
	<link rel="stylesheet" href="<%=basePath%>/jquery.Jcrop.min.css">
	<style type="text/css">
			body{background: #333;margin:0;padding:0;}
			.box{position: absolute;top:20px;left:30px;width:460px;height:360px;overflow:hidden;}
			...
			.img1{opacity: 0.5;width:100%;height:100%;}
			.img2{clip:rect(0px,20px,100px,100px);width:100%;height:100%;}

			#preview{position: absolute;top:20px;left:520px;width:460px;height:360px;}
			#preview #img3{position: absolute;top:0;left:0;width:100%;height:100%;}
		</style>
	<script src="<%=basePath%>/js/jquery.js"></script>
	<script src="<%=basePath%>/js/jquery-1.8.1.min.js"></script>
	<script src="<%=basePath%>/js/jquery.imgareaselect.js"></script>
  ...
  <body>
   	   <div id="box" class="box">
			<img class="img1" src="./images/Koala.jpg"/>
			<img id="img2" class="img2" src="./images/Koala.jpg"/>
		...
		<div id="preview">
			<img id="img3" class="img3" src="./images/Koala.jpg"/>
		</div>
