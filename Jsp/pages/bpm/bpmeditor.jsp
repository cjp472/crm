...
%>
  ...
  <div style="width:100%;height:50px;background-image:url('<%=basePath%>/images/f2.gif');padding-bottom:10px;"><h1 align="middle" style="padding-top:10px;"> &nbsp;&nbsp;ECCRM 在线流程设计器 </h1>
  </div>
  <div id="flashContent">
