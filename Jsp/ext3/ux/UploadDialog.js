...
//				})));
	...
	addFileToUploadQueue : function(browse_btn) {
		...
		//alert("addFileToUploadQueue"+browse_btn.detachInputFile());
		//alert("input_file:"+input_file.dom.value);
		//input_file.dom.value;//input_file.dom.value.replace("\\",'/');
		//alert("input_file.dom.value"+input_file.dom.value);
