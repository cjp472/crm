				            	     ...
				            	     alert("ee:"+UlEmpBTypeId);
				            	       if(UlEmpBTypeId!=null && UlEmpBTypeId!='' ){//存在设备
				            	    	  // EquipmentForm.selelctUlemployee(UlEmpBTypeId);
				            	    	   EqULempSelector.getView(
				            	   	            function(userNo,fullname,zhiwei){
				            	   	            	Ext.getCmp('UlEmpEquip').setValue(userNo);
				            	   	                Ext.getCmp('name').setValue(fullname);
				            	   	                Ext.getCmp('zhiwei').setValue(zhiwei);
				            	   	            },UlEmpBTypeId    
				            	   	        ).show();
				            	       }else{//不存在设备
				            	    	  alert("请选择所机构信息"); 
