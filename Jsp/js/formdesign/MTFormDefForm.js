 ...
 * @company 优创融联科技
 */
MTFormDefForm = Ext.extend(Ext.Window, {
			// 构造函数
			constructor : function(_cfg) {
				Ext.applyIf(this, _cfg);
				// 必须先初始化组件
				this.initUIComponents();
				MTFormDefForm.superclass.constructor.call(this, {
					id : 'MTFormDefFormWin',
					layout : 'fit',
					items : [this.formPanel,this.editorPanel],
					modal : true,
					height : 500,
					width : 650,
					maximizable : true,
			...
			initUIComponents : function() {
				...
				this.editorPanel=new Ext.Panel({
					...
					width:700,
					border:false,
					html:'<iframe id="formDesignFrame" src="'+__ctxPath+'/pages/mtFormDesign/mtFormEditor.jsp" width="100%" height="100%" frameborder="0"></iframe>'
				});
