MTFormDesignWindow=Ext.extend(Ext.Window,{
	constructor:function(config){
		...
		var panel=new Ext.Panel({
			...
			width:700,
			border:false,
			html:'<iframe id="formDesignFrame" src="'+__ctxPath+'/pages/flow/mtFormEditor.jsp?templateId='+this.templateId+'" width="100%" height="100%" frameborder="0"></iframe>'
		});
