 ...
 * @class CusPersonalViewCallin
 * @extends Ext.Panel
 * @description [CusPersonal]管理
 * @company 优创融联科技
 * @createtime:
 */
CusPersonalViewCallin = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				CusPersonalViewCallin.superclass.constructor.call(this, {
							id : 'CusPersonalViewCallinWin',
							title : '个人客户管理',
							region : 'center',
							layout : 'border',
...
//								dataIndex : 'ext20'
			...
			// 创建记录
			createRs : function() {
				// new CusPersonalFormCallin().show();
				var tabs = Ext.getCmp('centerTabPanel');
				var aForm = Ext.getCmp('CusPersonalFormCallin');
				if (aForm != null) {
					tabs.remove('CusPersonalFormCallin');
				}
				aForm = new CusPersonalFormCallin();
				tabs.add(aForm);
				tabs.activate(aForm);
