 ...
 * @createtime:
 */
MyCusPersonalView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				MyCusPersonalView.superclass.constructor.call(this, {
							id : 'MyCusPersonalViewWin',
							title : '个人客户管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					columns : [{
								...
								header : '客户行业：金融、地产、制造等',
								isExp : false,
								hidden : true,
								dataIndex : 'cusTraId'
							}, {
								header : '客户职位：CEO、CIO、工程师',
								isExp : false,
								hidden : true,
								dataIndex : 'jobTypId'
							}, {
								header : '客户等级：黑卡、金卡、普卡',
								isExp : false,
								hidden : true,
								dataIndex : 'cusGraId'
							}, {
