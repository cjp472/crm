...
WantServiceView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		WantServiceView.superclass.constructor.call(this, {
			id : 'WantServiceViewWin',
			title : '待跟踪请求',
			region : 'center',
			layout : 'border',
...
//						url : __ctxPath + '/customer/listlinkmanid.do',
		...
		this.searchPanel = new Ext.FormPanel( {
			layout : 'hbox',
			region : 'north',
			id : 'WantConServiceRequestSearchPanel',
			height : 35,
			items : [{
				border:false,
		...
		this.gridPanel = new HT.GridPanel( {
			...
			exportable : false,
			showSm : false,
			id : 'WantConServiceRequestGrid',
			url : __ctxPath + "/customer/listConServiceRequest.do?Q_status_L_EQ=1",//待跟踪的
			fields : [ {
...
//				},
	...
	onSearch : function(obj) {
		var searchPanel = Ext.getCmp('WantConServiceRequestSearchPanel');
		var gridPanel = Ext.getCmp('WantConServiceRequestGrid');
