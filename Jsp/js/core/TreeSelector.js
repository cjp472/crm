 ...
 */
var TreeSelector = function(_id,_url,_label,_field,_isBlank,_readOnly,_hidden,_width,_anchor) {
	var config={
		id:_id,
		...
		fieldLabel:_label,
		labelWidth : 60,
		hidden : _hidden==true?true:false,
		hideLabel : _hidden==true?true:false,
