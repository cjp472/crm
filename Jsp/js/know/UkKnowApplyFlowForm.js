 ...
 * @class UkKnowApplyFlowForm
 * @extends Ext.Window
 * @description 知识申请表单
 * @company 优创融联科技
 */
UkKnowApplyFlowForm = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		UkKnowApplyFlowForm.superclass.constructor.call(this, {
					id : 'UkKnowApplyFlowForm',
					layout : 'form',
	...
	cancel : function() {
		...
		tabs.remove('UkKnowApplyFlowFormWin');
		this.destroy();
	},
	/**
	 * 显示流程图
...
UkKnowApplyFlowForm.prototype.initToolbar = function() {
