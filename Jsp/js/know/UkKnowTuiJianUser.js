/**
 * @description 用户选择器
 * @class UkKnowTuiJianUser
 * @author 优创融联科技
 * @updater zhangyl
 * @createtime 2012年9月11日 18:23:02
 */
var UkKnowTuiJianUser = {
...
//										return '<img src="'+__ctxPath+'/images/flag/women.png"/>&nbsp;' + value.fullname;	
		...
		var searchPanel = new Ext.FormPanel({
					...
					id : 'UkKnowTuiJianUserSearchPanel',
					height : 38,
					region : 'north',
					layout : 'hbox',
...
//			alert(node.id);
	 ...
	 */
	search : function() {
		var searchPanel = Ext.getCmp('UkKnowTuiJianUserSearchPanel');
		var contactGrid = Ext.getCmp('contactGrid');
	...
	submit : function() {
		...
		if (this.isSingle == null || this.isSingle) {// 选择单个用户
			...
			Ext.Ajax.request({
				url:__ctxPath+'/know/saveTuiJianUkPerKnow.do',
				params:{
					userIds:userIds,
					knowId : this.knowId
				},
		...
		Ext.getCmp('UkKnowTuiJianUserWin').close();
	},
