...
UkTopSysKnowView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				UkTopSysKnowView.superclass.constructor.call(this, {
							id : 'UkTopSysKnowViewWin',
							title : '知识排行榜',// '[UkSysKnow]管理',
							region : 'center',
							layout : 'border',
...
//					rowActions : true,
					...
					showSm:false,
					id : 'UkTopSysKnowGrid',
//					url : __ctxPath + "/know/paiHangListUkSysKnow.do",
