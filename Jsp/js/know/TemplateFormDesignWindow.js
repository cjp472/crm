TemplateFormDesignWindow=Ext.extend(Ext.Window,{
	constructor:function(config){
		...
		this.buttons=[
			{
					...
					handler : function() {
						...
						//取得
						Ext.Ajax.request({
							url:__ctxPath+'/know/saveTemplateUkKnowTemplate.do',
							params:params,
							method:'POST',
		...
		var panel=new Ext.Panel({
			...
			width:700,
			border:false,
			html:'<iframe id="formDesignFrame" src="'+__ctxPath+'/pages/ukSysKnow/formTemplateEditor.jsp?knowTmpId='+this.knowTmpId+'" width="100%" height="100%" frameborder="0"></iframe>'
		});
		
		TemplateFormDesignWindow.superclass.constructor.call(this,{
			title:'流程表单设计',
			height : 550,
			width : 1000,
			modal:true,
