...
UkDianPingSysKnowView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				UkDianPingSysKnowView.superclass.constructor.call(this, {
							id : 'UkDianPingSysKnowViewWin',
							title : '知识点评榜',// '[UkSysKnow]管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				var UkSysKnowAdvancedSearchWin = Ext.extend(
...
//					rowActions : true,
					...
					exportable : false,
					showSm:false,
					id : 'UkSysKnowDianpingGrid',
//					url : __ctxPath + "/know/dianPingListUkSysKnow.do",
					url : __ctxPath + "/know/queryKnowListUkSysKnow.do",
					baseParams : {
						status : 5,
						isdianpingCount : true,
						isPermission : 1,
						isOverdue : 'notCheck'
					},
					fields : [{
							...
							'viewCount', 'dianpingCount', 'sysKnowComment',
							...
							'ukKnowKeywords', 'dianpingValue' ,'averageCount','accessManage','knowKeyWords'],
					columns : [{
