BJGenZongView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		BJGenZongView.superclass.constructor.call(this, {
			id : 'BJGenZongViewWin',
			title : '报价跟踪',
			region : 'center',
			layout : 'border',
		...
		this.gridPanel = new HT.GridPanel({
			...
			tbar : ['->',{
				...
				handler : function() {
					...
					var aForm = Ext.getCmp('BJLuRuFormWin');
					if (aForm != null) {
						tabs.remove('BJLuRuFormWin');
					}
					aForm = new BJLuRuForm();
					tabs.add(aForm);
					tabs.activate(aForm);
				}
			},{
