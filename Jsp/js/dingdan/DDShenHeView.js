DDShenHeView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		DDShenHeView.superclass.constructor.call(this, {
			id : 'DDShenHeViewWin',
			title : '订单审核管理',
			region : 'center',
			layout : 'border',
	...
	onRowAction : function(grid, record, action, row, col) {
		switch (action) {
			case 'menu-seal' :
				var tabs = Ext.getCmp('centerTabPanel');
				var aForm = Ext.getCmp('DDShenHeFormWin');
				if (aForm != null) {
					tabs.remove('DDShenHeFormWin');
				}
				aForm = new DDShenHeForm({
