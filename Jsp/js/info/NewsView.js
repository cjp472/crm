		...
		this.gridPanel = new HT.GridPanel({
			...
			columns : [{
						...
						renderer : function(value, metadata, record) {
							var reVal = '';
							reVal += '<a href="#" onclick="App.MyDesktopClickTopTab(\'NewsDetail\','
									+ record.data.newsId + ')">';
							reVal += value
							reVal += "</a>";
							reVal += '&nbsp;&nbsp;';
...
//		var searchPanel = Ext.getCmp('UkNewsSearchPanel');
	...
	onRowAction : function(grid, record, action, row, col) {
		switch (action) {
			...
			case 'btn-edit' :
				...
				break;
			case 'btn-tips' :
				this.updateRs.call(this, record);
				break;
			default :
				break;
		}
