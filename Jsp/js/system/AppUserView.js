...
//	Ext.getCmp('appUser.beginDate').setValue(new Date());
//	Ext.getCmp('appUser.endDate').setValue('9999-12-31');
//	Ext.getCmp('appUserUserType').setValue(0);
	// 显示修改密码按钮
...
//							Ext.getCmp('empPhone').setValue('暂无');
					...
					var beginDate = getDateFromFormat(new Daet());
...
//					alert(Ext.getCmp('appUser.beginDate').getValue());
					...
					Ext.getCmp('appUser.endDate').setValue('9999-12-31');
					Ext.getCmp('appUserUserType').setValue('正式');
