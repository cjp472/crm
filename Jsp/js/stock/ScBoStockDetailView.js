 ...
 * @class ScBoStockDetailView
 * @extends Ext.Panel
 * @description [ScBoStockDetail]管理
 * @company 优创融联科技
 * @createtime:
 */
ScBoStockDetailView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				ScBoStockDetailView.superclass.constructor.call(this, {
							id : 'ScBoStockDetailViewWin',
							title : '[ScBoStockDetail]管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				var ScBoStockDetailAdvancedSearchWin = Ext.extend(MT.AdvancedSearchWin, {
					title : '[ScBoStockDetail]高级查询',
				...
				this.searchPanel = new Ext.FormPanel({
							...
							height : 35,
										...
										iconCls : 'search',
										scope : this,
										handler :function(){ new ScBoStockDetailAdvancedSearchWin().show();}
									}
								],
								layoutConfig : {
									padding : '5',
				...
				this.gridPanel=new HT.GridPanel({
					...
					printable : false,
					exportable : false,
					id:'ScBoStockDetailGrid',
					url : __ctxPath + "/stock/listScBoStockDetail.do",
					fields : [{
...
//				var searchPanel = Ext.getCmp('ScBoStockDetailSearchPanel');
...
//				}
			...
			rowClick:function(grid,rowindex, e) {
				grid.getSelectionModel().each(function(rec) {
					new ScBoStockDetailForm({bizOrderDetailId:rec.data.bizOrderDetailId}).show();
				});
			},
			//创建记录
			createRs : function() {
				//new ScBoStockDetailForm().show();
				var tabs = Ext.getCmp('centerTabPanel');
				var aForm = Ext.getCmp('ScBoStockDetailForm');
				if (aForm != null) {
					tabs.remove('ScBoStockDetailForm');
				}
				aForm = new ScBoStockDetailForm();
				tabs.add(aForm);
				tabs.activate(aForm);
			...
			removeRs : function(id) {
				$postSubmit({
					url:__ctxPath+ '/stock/multiDelScBoStockDetail.do',
					ids:id,
					grid:this.gridPanel,
					msgTip : '您确认要删除所选记录吗？',
					msgSuccess : '成功删除该记录！',
			...
			editRs : function(record) {
				...
				aForm = new ScBoStockDetailForm({bizOrderDetailId : record.data.bizOrderDetailId});
				tabs.add(aForm);
				tabs.activate(aForm);
			},
			//行的Action
