...
UnimhandupView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				UnimhandupView.superclass.constructor.call(this, {
							id : 'UnimhandupViewWin',
							title : '举手原因管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					printable : false,
					exportable : false,
					id : 'UnimCategoryGridYY',
					url : __ctxPath + "/unim/listUnimCategory.do?Q_typeId_SN_EQ=4",
					fields : [{
								name : 'catId',
								type : 'int'
