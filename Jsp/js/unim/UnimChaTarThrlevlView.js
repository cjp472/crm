 ...
 * @class UnimChaTarThrlevlView
 * @extends Ext.Panel
 * @description [UnimChaTarThrlevl]管理
 * @company 优创融联科技
 * @createtime:
 */
UnimChaTarThrlevlView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				UnimChaTarThrlevlView.superclass.constructor.call(this, {
							id : 'UnimChaTarThrlevlViewWin',
							title : '[UnimChaTarThrlevl]管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				var UnimChaTarThrlevlAdvancedSearchWin = Ext.extend(MT.AdvancedSearchWin, {
					title : '[UnimChaTarThrlevl]高级查询',
				...
				this.searchPanel = new Ext.FormPanel({
							layout : 'hbox',
							region : 'north',
							id : 'UnimChaTarThrlevlSearchPanel',
							height : 35,
													items:[
																						 																																												 										{
										...
										iconCls : 'search',
										scope : this,
										handler :function(){ new UnimChaTarThrlevlAdvancedSearchWin().show();}
									}
								],
								layoutConfig : {
									padding : '5',
				...
				this.topbar = new Ext.Toolbar({
						items : [{
									iconCls : 'btn-add',
									//text : __create+'[UnimChaTarThrlevl]',
									text : __create,
									xtype : 'button',
									scope : this,
									...
									iconCls : 'btn-del',
									//text : __delete+'[UnimChaTarThrlevl]',
									text : __delete,
									xtype : 'button',
									scope:this,
				...
				this.gridPanel=new HT.GridPanel({
					...
					printable : false,
					exportable : false,
					id:'UnimChaTarThrlevlGrid',
					url : __ctxPath + "/unim/listUnimChaTarThrlevl.do",
					fields : [{
									name : 'thrlevlId',
									type : 'int'
								}
...
//				var searchPanel = Ext.getCmp('UnimChaTarThrlevlSearchPanel');
...
//				}
			...
			rowClick:function(grid,rowindex, e) {
				grid.getSelectionModel().each(function(rec) {
					new UnimChaTarThrlevlForm({thrlevlId:rec.data.thrlevlId}).show();
				});
			},
			//创建记录
			createRs : function() {
				//new UnimChaTarThrlevlForm().show();
				var tabs = Ext.getCmp('centerTabPanel');
				var aForm = Ext.getCmp('UnimChaTarThrlevlForm');
				if (aForm != null) {
					tabs.remove('UnimChaTarThrlevlForm');
				}
				aForm = new UnimChaTarThrlevlForm();
				tabs.add(aForm);
				tabs.activate(aForm);
			...
			removeRs : function(id) {
				$postSubmit({
					url:__ctxPath+ '/unim/multiDelUnimChaTarThrlevl.do',
					ids:id,
					grid:this.gridPanel,
					msgTip : '您确认要删除所选记录吗？',
					msgSuccess : '成功删除该记录！',
			...
			editRs : function(record) {
				...
				aForm = new UnimChaTarThrlevlForm({thrlevlId : record.data.thrlevlId});
				tabs.add(aForm);
				tabs.activate(aForm);
			},
			//行的Action
