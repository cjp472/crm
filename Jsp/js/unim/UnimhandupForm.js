UnimhandupForm = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		UnimhandupForm.superclass.constructor.call(this, {
			id : 'UnimhandupFormWin',
			layout : 'fit',
	...
	save : function() {
		$postSubForm({
			...
			scope : this,
			url : __ctxPath + '/unim/saveUnimCategory.do?unimCategory.typeId=4',
			msgSuccess : '成功保存该记录！',
			msgFailure : '操作出错，请联系管理员！',
			callback : function(fp, action) {
				var gridPanel = Ext.getCmp('UnimCategoryGridYY');
				if (gridPanel != null) {
