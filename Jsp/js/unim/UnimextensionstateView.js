UnimextensionstateView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				UnimextensionstateView.superclass.constructor.call(this, {
							id : 'UnimextensionstateViewWin',
							title : '员工状态管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					printable : false,
					exportable : false,
					id : 'UnimCategoryGridZT',
					url : __ctxPath
							+ "/unim/listUnimCategory.do?Q_typeId_SN_EQ=2",
					fields : [{
								name : 'catId',
								type : 'int'
							}, 'typeId', 'catName', 'catCode', 'extend1',
							'extend2', 'remark','extend2'],
					columns : [{
								header : 'catId',
								dataIndex : 'catId',
								hidden : true
			...
			// 创建记录
			createRs : function() {
				new UnimextensionstateForm().show();
