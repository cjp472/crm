...
AssetFaZhiView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				AssetFaZhiView.superclass.constructor.call(this, {
							id : 'AssetFaZhiViewWin',
							title : '状态阀值管理',
							region : 'center',
							layout : 'border',
...
//										store:[]
				...
				this.gridPanel = new HT.GridPanel({
					...
					exportable : false,
					id : 'UnimAssetsTarget',
					url : __ctxPath + "/unim/listevlUnimAssetsTarget.do",
					fields : [{
								name : 'targetId',
								type : 'Long'
...
//				tabs.activate(aForm);
			...
			removeRs : function(id) {
				$postSubmit({
							url : __ctxPath + '/unim/clearFZUnimAssTarThrlevl.do',
							ids : id,
							grid : this.gridPanel,
				        	msgNull : '请选择要置空的记录！',
							msgTip : '您确认要置空所选记录吗？',
