...
//		store.setDefaultSort('id', 'desc');
		...
		var searchPanel = new HT.SearchPanel({
					...
					id : 'UnimZCMaptSelectorSearchPanel',
					width : 600,
					height : 100,
					region : 'north',
					//labelWidth:100,
	 ...
	 */
	search : function() {
		var searchPanel = Ext.getCmp('UnimZCMaptSelectorSearchPanel');
	...
	submit : function() {
		...
		Ext.getCmp('UnimZCMaptSelectorWin').close();
	},
