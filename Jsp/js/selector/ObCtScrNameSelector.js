	...
	initPanel : function(isSingle) {
		...
		var store = new Ext.data.Store({
					proxy : new Ext.data.HttpProxy({
								url : __ctxPath + '/comtech/ctScrNamlistCtScrTemplate.do'
							}),
...
//						}
		...
		var searchPanel = new HT.SearchPanel({
					...
					id : 'ObCtScrNameSelectorSearchPanel',
					width : 600,
					height : 100,
	 ...
	 */
	search : function() {
		var searchPanel = Ext.getCmp('ObCtScrNameSelectorSearchPanel');
...
//		}
	 ...
	 var rows = grid.getSelectionModel().getSelections();
		...
		Ext.getCmp('ObCtScrNameSelectorWin').close();
	},
