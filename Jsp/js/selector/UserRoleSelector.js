...
//				depNames += rows[i].get('department.depName');
//				depIds += rows[i].get('department.depId');
			}
		} else {
...
//				depIds += rows[i].get('department.depId');
		...
		if (this.callback != null)
			this.callback.call(this.scope, userIds, fullnames,employeeids,depNames,depIds);
