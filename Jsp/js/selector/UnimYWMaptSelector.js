...
//		store.setDefaultSort('id', 'desc');
		...
		var searchPanel = new HT.SearchPanel({
					...
					id : 'UnimYWMaptSelectorSearchPanel',
					width : 600,
					height : 100,
					region : 'north',
					//labelWidth:100,
	 ...
	 */
	search : function() {
		var searchPanel = Ext.getCmp('UnimYWMaptSelectorSearchPanel');
	...
	submit : function() {
		...
		Ext.getCmp('UnimYWMaptSelectorWin').close();
	},
