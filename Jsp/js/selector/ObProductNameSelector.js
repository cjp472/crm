	...
	initPanel : function(isSingle) {
		...
		var store = new Ext.data.Store({
					proxy : new Ext.data.HttpProxy({
								url : __ctxPath + '/supply/productNamlistScGoods.do?comid='+isSingle
							}),
					reader : new Ext.data.JsonReader({
								...
								fields : [{
											name : ' goodsId',
											type : 'Long'
										}, 'goodsName','goodsId','retailPrice','numbers','comSta','ext1','goodtype','reportPrice','style','ext1','distribution']
							}),
					remoteSort : true
				});
//		store.setDefaultSort('id', 'desc');
		...
		var searchPanel = new HT.SearchPanel({
					...
					id : 'ObProductNameSelectorSearchPanel',
					width : 600,
					height : 100,
					region : 'north',colNums : 3,
					labelAlign:'right',
					labelWidth:60,
					layout : 'form',
					items : [
	 ...
	 */
	search : function() {
		var searchPanel = Ext.getCmp('ObProductNameSelectorSearchPanel');
...
//		}
	 ...
	 var rows = grid.getSelectionModel().getSelections();
		...
		Ext.getCmp('ObProductNameSelectorWin').close();
	},
