/**下拉树工具类
 * 用法: new UkKnowDimenTreeSelector(_id,_url,_label,_field,_isBlank); 返回类型为Ext.form.ComboBox
 * @param {} _id:下拉树的ID
 ...
 */
var UkKnowDimenTreeSelector = function(_id,_url,_label,_field,_isBlank,_anchor,_readFlag) {
	var config={
		id:_id,
