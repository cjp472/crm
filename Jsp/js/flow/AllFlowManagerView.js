Ext.ns('AllFlowManagerView');
/**
 * 我的任务流程 
 */
var AllFlowManagerView=function(){
	var searchPanel = new HT.SearchPanel({
							layout : 'hbox',
							region : 'north',
							id : 'AllFlowManagerSearchForm',
							// colNums : 3,
							height : 35,
							items : [{
										...
										text : "流程状态"// __ukKnowApproveApproveTitle
									}, {
										hiddenName : 'runStatus',
										xtype : 'mtdiccombo',
										editable : false,
										lazyInit : false,
										forceSelection : false,
										...
										scope : this,
										handler : function() {
											var searchPanel = Ext.getCmp('AllFlowManagerSearchForm');
											var gridPanel = Ext.getCmp('AllFlowManagerGrid');
...
AllFlowManagerView.prototype.setup=function(){
	//显示一个GridPanel先即可
...
//	      },
	      ...
	      ,{
	      	...
	      	renderer:function(value,metadata,record,rowIndex,colIndex){
	      		...
	      		var str='';//AllFlowManagerView.lockTask('+taskId+')
	      		str+='<button title="查看" class="btn-detail" onclick="AllFlowManagerView.trackRs(\''+flowPk+'\',\''+runId+'\',\''+fm+'\')"></button>';
...
//										iconCls : 'btn-refresh',
//										handler : function() {
//											Ext.getCmp('AllFlowManagerGrid').getStore().reload();
//										}
//									}]
//		}),
  		cm:cm,
...
//										AllFlowManagerView.nextStep(rec.data.taskId,rec.data.activityName);
//							});
//						});
...
AllFlowManagerView.prototype.initData=function(){
 ...
 * @param {} taskdbid
 */
AllFlowManagerView.lockTask=function(taskId){
	Ext.Ajax.request({
		...
		success:function(result,response){
			var grid=Ext.getCmp("AllFlowManagerGrid");
 ...
 * @param {} taskId
 */
AllFlowManagerView.changeTask=function(taskId,taskname){
 ...
 * @param {} taskdbid
 */
AllFlowManagerView.unlockTask=function(taskId){
	Ext.Ajax.request({
 ...
 * @param {} taskdbid
 */
AllFlowManagerView.nextStep=function(taskId,activityName){
...
AllFlowManagerView.trackRs=function(flowPk,runId,fm){
