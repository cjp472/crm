...
//			alert("1");
//			store.url = __ctxPath + '/communicate/listByGroupIdPhoneBook.do';
//			store.baseParams = { 
//				'Q_phoneGroups.groupId_L_EQ' : node.id>0?node.id:'',
 ...
 */
   select : function(node) {
	var users = Ext.getCmp('UlEmployeeGrid1');
	var store = users.getStore();
	store.url = __ctxPath + '/xitong/listUlEmployee.do';
	store.baseParams = { 
				'Q_phoneGroups.groupId_L_EQ' : node.id>0?node.id:''
//				'Q_appUser.userId_L_EQ':curUserInfo.userId
//				'Q_phoneGroup.isPublic_SN_EQ':0
