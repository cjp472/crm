 ...
 * @createtime
 * @class ObCalllistZHuishouForm
 * @extends Ext.Window
 * @description ObCallbatch表单
 * @company 优创融联科技
 */
ObCalllistZHuishouForm = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		ObCalllistZHuishouForm.superclass.constructor.call(this, {
					id : 'ObCalllistZHuishouFormWin',
					layout : 'fit',
	...
	cancel : function() {
		...
		tabs.remove('ObCalllistZHuishouFormWin');// 移除创建的窗口
	},
	/**
	 * 保存记录
	 */
