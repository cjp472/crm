 ...
 * @createtime
 * @class ObCallbatchWindow
 * @extends Ext.Window
 * @description ObCallbatch表单
 * @company 优创融联科技
 */
ObCallbatchWindow = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		ObCallbatchWindow.superclass.constructor.call(this, {
					id : 'ObCallbatchWindowWin',
					layout : 'fit',
					items : this.panel,
					modal : true,
					height : 430,
	...
	cancel : function() {
		Ext.getCmp('ObCallbatchWindowWin').close();
	},
	save : function() {
		var panels = Ext.getCmp('ObCallbatchWindowWin');
