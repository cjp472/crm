 ...
 * @createtime:
 */
zhanghukoutouguashiView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		zhanghukoutouguashiView.superclass.constructor.call(this, {
			id : 'zhanghukoutouguashiViewWin',
			title : '账户口头挂失查询',
			region : 'center',
			layout : 'border',
	...
	this.hisPanelGrid = new HT.GridPanel( {
		...
		this.mainPanel = new Ext.Panel({
					...
					id : 'MainPanel',
					split : true,
					items : [this.searchPanel, this.hisPanel]
				});
		//主框架结束
