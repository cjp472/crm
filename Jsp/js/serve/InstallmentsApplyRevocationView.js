 ...
 * @createtime:
 */
InstallmentsApplyRevocationView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		InstallmentsApplyRevocationView.superclass.constructor.call(this, {
			id : 'InstallmentsApplyRevocationViewWin',
			title : '分期付款申请/撤销',
			region : 'center',
			layout : 'border',
