 ...
 * @createtime:
 */
WBCunKuanView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		WBCunKuanView.superclass.constructor.call(this, {
			id : 'WBCunKuanViewWin',
			title : '外币存款利率查询',
			region : 'center',
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel( {
			...
			exportable : false,
			id : 'CusHisGrid',
			url : __ctxPath + "/serve/listWBCunKuanHasChargeBill.do",
			fields : [ {
				name : 'id',
				type : 'int'
