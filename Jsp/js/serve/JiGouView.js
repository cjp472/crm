 ...
 * @createtime:
 */
JiGouView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		JiGouView.superclass.constructor.call(this, {
			id : 'JiGouViewWin',
			title : '机构查询',
			region : 'center',
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel( {
			...
			exportable : false,
			id : 'CusHisGrid',
			url : __ctxPath + "/serve/listJiGouHasChargeBill.do",
			fields : [ {
				name : 'opeHisId',
				type : 'int'
