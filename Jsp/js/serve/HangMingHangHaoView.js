 ...
 * @createtime:
 */
HangMingHangHaoView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		HangMingHangHaoView.superclass.constructor.call(this, {
			id : 'HangMingHangHaoViewWin',
			title : '行名行号查询',
			region : 'center',
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel( {
			...
			exportable : false,
			id : 'CusHisGrid',
			url : __ctxPath + "/serve/listHangMingHangHaoHasChargeBill.do",
			fields : [ {
				name : 'id',
				type : 'int'
			}, 'EX1', 'EX2', 'EX3', 'EX4', 'EX5' ],
