 ...
 * @createtime:
 */
HasChargeBillView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		HasChargeBillView.superclass.constructor.call(this, {
			id : 'HasChargeBillViewWin',
			title : '已出账单明细',
			region : 'center',
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel( {
			...
			exportable : false,
			id : 'CusHisGrid',
			url : __ctxPath + "/serve/listHasChargeBill.do",
			fields : [ {
				name : 'id',
				type : 'int'
			}, 'recordTime', 'consumptionTime', 'tradingNo', 'amount', 'currency' , 'note' , 'afterFour' , 'isInstallment' , 'revoked' ],
			columns : [ {
				header : '内码',
				dataIndex : 'id',
				hidden : true
	...
	this.knowsPanelGrid = new HT.GridPanel( {
		...
		this.knowsPanelGrid.addListener('rowdblclick', this.knowsRowClick);
	...
	knowsRowClick : function(grid, rowindex, e) {
