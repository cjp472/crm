 ...
 * @createtime:
 */
huoqizhanghujiaoyiView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		huoqizhanghujiaoyiView.superclass.constructor.call(this, {
			id : 'huoqizhanghujiaoyiViewWin',
			title : '活期账户交易查询',
			region : 'center',
			layout : 'border',
	...
	this.hisPanelGrid = new HT.GridPanel( {
		...
		this.knowsSearchPanel = new Ext.FormPanel({
			...
			items : [{
						...
						iconCls : 'search',
						scope : this,
						handler : this.onKnowSearch.createCallback(this)
					}, {
						xtype : 'button',
						text : '更多',
						scope : this,
	...
	onKnowSearch : function(obj) {
		var searchPanel = Ext.getCmp('UkSysKnowSearchPanel');
		var gridPanel = Ext.getCmp('knowsPanelGrid');
