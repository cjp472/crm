...
/**
 * UkKnowCollectType Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class UkKnowCollectType extends com.htsoft.core.model.BaseModel {

    protected Long knowCollectTypeId;
	...
	protected java.util.Set<UkSysKnow> ukCollectKnows = new java.util.HashSet<UkSysKnow>();

	/**
	 * Default Empty Constructor for class UkKnowCollectType
	 */
	public UkKnowCollectType () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class UkKnowCollectType
	 */
	public UkKnowCollectType (
		 Long in_knowCollectTypeId
        ) {
		this.setKnowCollectTypeId(in_knowCollectTypeId);
    }
	...
	public java.util.Set getUkCollectKnows () {
		return ukCollectKnows;
	}	
	
	public void setUkCollectKnows (java.util.Set in_ukCollectKnows) {
		this.ukCollectKnows = in_ukCollectKnows;
	}
    

	/**
	 * 知识库收藏分类内码	 * @return Long
     * @hibernate.id column="KNOW_COLLECT_TYPE_ID" type="java.lang.Long" generator-class="native"
	 */
	public Long getKnowCollectTypeId() {
		return this.knowCollectTypeId;
	}
	
	/**
	 * Set the knowCollectTypeId
	 */	
	public void setKnowCollectTypeId(Long aValue) {
		this.knowCollectTypeId = aValue;
	}	
	...
	/**
	 * 知识模板编号	 * @return Long
	 * @hibernate.property column="KNOW_TMP_ID" type="java.lang.Long" length="18" not-null="false" unique="false"
	 */
	...
	/**
	 * 创建人姓名	 * @return String
	 * @hibernate.property column="CREATE_BY" type="java.lang.String" length="100" not-null="false" unique="false"
	 */
	...
	/**
	 * 修改人	 * @return String
	 * @hibernate.property column="UPDATE_BY" type="java.lang.String" length="100" not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		if (!(object instanceof UkKnowCollectType)) {
			return false;
		}
		UkKnowCollectType rhs = (UkKnowCollectType) object;
		return new EqualsBuilder()
				.append(this.knowCollectTypeId, rhs.knowCollectTypeId)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.knowCollectTypeId) 
						.append(this.knowTmpId) 
				.append(this.name) 
				.append(this.comMent) 
	...
	public String toString() {
		return new ToStringBuilder(this)
				.append("knowCollectTypeId", this.knowCollectTypeId) 
						.append("knowTmpId", this.knowTmpId) 
