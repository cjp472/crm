...
public class ConBwListBusRulDaoImpl extends BaseDaoImpl<ConBwListBusRul> implements ConBwListBusRulDao{

	public ConBwListBusRulDaoImpl() {
		super(ConBwListBusRul.class);
	}
