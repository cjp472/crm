...
public interface CusPersonalService extends BaseService<CusPersonal>{
	//根据手机号查询是否存在客户
	...
	//保存个人客户的表头与行信息
	public String saveCusPer(String details,String linkManLines,String delContactLines,String delLinkLines,CusPersonal cusPersonal);
	//根据客户号查询客户信息
