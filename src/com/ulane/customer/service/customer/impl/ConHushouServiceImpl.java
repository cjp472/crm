...
public class ConHushouServiceImpl extends BaseServiceImpl<ConHushou> implements ConHushouService{
	@SuppressWarnings("unused")
	private ConHushouDao dao;
	
	public ConHushouServiceImpl(ConHushouDao dao) {
		super(dao);
		this.dao=dao;
	}
