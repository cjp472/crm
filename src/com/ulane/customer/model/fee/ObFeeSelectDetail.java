 ...
 * 
 */
public class ObFeeSelectDetail extends com.htsoft.core.model.BaseModel {
	...
	protected Long zhibiaoxiang;					//指标项
	...
	public String toString() {
		return "ObFeeSelect [amount=" + amount + ", changedAmount="
				...
				+ kehujieanshu + ", month=" + month + ", obFeeIndexProject="
				+ obFeeIndexProject + ", quarter=" + quarter + ", staId="
				+ staId + ", touTouLv=" + touTouLv + ", ulEmployee="
				+ ulEmployee + ", updateBy=" + updateBy + ", updateDate="
				+ updateDate + ", userNam=" + userNam + ", userNo=" + userNo
				+ ", yongjin=" + yongjin + ", youXiaoJinE=" + youXiaoJinE + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ObFeeSelectDetail other = (ObFeeSelectDetail) obj;
		if (amount == null) {
