...
/**
 * CusPurchaseCompany Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
...
public class CusPurchaseCompany extends com.htsoft.core.model.BaseModel {
	...
	/**
	 * Default Empty Constructor for class CusPurchaseCompany
	 */
	public CusPurchaseCompany () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class CusPurchaseCompany
	 */
	public CusPurchaseCompany (
		 Long in_customerid
        ) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof CusPurchaseCompany)) {
			return false;
		}
		CusPurchaseCompany rhs = (CusPurchaseCompany) object;
