...
/**
 * ObCallbatchImpWash Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
...
public class ObCallbatchImpWash extends com.htsoft.core.model.BaseModel {

    protected Long washCusId;
...
//	protected com.ulane.callout.model.outb.ObConCalllist obConCalllist;
	...
	/**
	 * Default Empty Constructor for class ObCallbatchImpWash
	 */
	public ObCallbatchImpWash () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ObCallbatchImpWash
	 */
	public ObCallbatchImpWash (
		 Long in_washCusId
        ) {
		this.setWashCusId(in_washCusId);
    }
...
//    
	...
	/**
	 * 清洗客户内码	 * @return Long
     * @hibernate.id column="WASH_CUS_ID" type="java.lang.Long" generator-class="native"
	 */
	public Long getWashCusId() {
		return this.washCusId;
	}
	
	/**
	 * Set the washCusId
	 */	
	public void setWashCusId(Long aValue) {
		this.washCusId = aValue;
	}	
...
//	}	
	...
	public boolean equals(Object object) {
		if (!(object instanceof ObCallbatchImpWash)) {
			return false;
		}
		ObCallbatchImpWash rhs = (ObCallbatchImpWash) object;
		return new EqualsBuilder()
				.append(this.washCusId, rhs.washCusId)
	...
	public String toString() {
		return new ToStringBuilder(this)
				.append("washCusId", this.washCusId) 
