...
public class FileUtils {
    ...
    public static void main(String[] args) throws IOException{
    	...
    	String s=util.readTxt("F:/abc.xls", "UTF-8");
     ...
     * @param req 
     * @param file
     * @param param attachFiles下面的文件夹的名字，如：taobao,dangdang等
     * @author CAOLI
     */
    public static String uploadFile(HttpServletRequest req,File file,String param) {

		PathUtil p=new PathUtil();
		String webroot;
		String fileName = null;
		try {
		webroot = p.getWebRoot();	
		Date date=new Date();
		String ux=DateUtil.formatUxDate(date);
		fileName = webroot+"attachFiles/"+param+"/"+ux+".xls";
