...
/**
 * UnimChannelNavigation Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class UnimChannelNavigation extends com.htsoft.core.model.BaseModel {
	...
	protected java.util.Set unimChannelMaps = new java.util.HashSet();
	...
	/**
	 * Default Empty Constructor for class UnimChannelNavigation
	 */
	public UnimChannelNavigation () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class UnimChannelNavigation
	 */
	public UnimChannelNavigation (
		 Long in_mapNavId
        ) {
	...
	public java.util.Set getUnimChannelMaps () {
		return unimChannelMaps;
	}	
	
	public void setUnimChannelMaps (java.util.Set in_unimChannelMaps) {
		this.unimChannelMaps = in_unimChannelMaps;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnimChannelNavigation other = (UnimChannelNavigation) obj;
		if (mapId == null) {
			if (other.mapId != null)
				return false;
		...
		if (status == null) {
			...
			return false;
		if (unimChannelMaps == null) {
			if (other.unimChannelMaps != null)
				return false;
		} else if (!unimChannelMaps.equals(other.unimChannelMaps))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((unimChannelMaps == null) ? 0 : unimChannelMaps.hashCode());
		return result;
	}

	@Override
	public String toString() {
		return "UnimChannelNavigation [mapId=" + mapId + ", mapNam=" + mapNam
				+ ", mapNavId=" + mapNavId + ", navName=" + navName
				+ ", orderno=" + orderno + ", parentNam=" + parentNam
				+ ", parentid=" + parentid + ", remark=" + remark + ", status="
				+ status + 
//				", unimChannelMaps=" + unimChannelMaps + 
				"]";
	}
