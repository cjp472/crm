...
/**
 * UnimAssetsMap Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
...
public class UnimAssetsMap extends com.htsoft.core.model.BaseModel {
	...
	protected com.ulane.monitor.model.unim.UnimAssetsNavigation unimAssetsNavigation;

	protected java.util.Set<UnimAgent> unimAgents = new java.util.HashSet<UnimAgent>();

	/**
	 * Default Empty Constructor for class UnimAssetsMap
	 */
	public UnimAssetsMap () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class UnimAssetsMap
	 */
	public UnimAssetsMap (
		 Long in_mapId
        ) {
	...
	public com.ulane.monitor.model.unim.UnimAssetsNavigation getUnimAssetsNavigation () {
		return unimAssetsNavigation;
	}	
	
	public void setUnimAssetsNavigation (com.ulane.monitor.model.unim.UnimAssetsNavigation in_unimAssetsNavigation) {
		this.unimAssetsNavigation = in_unimAssetsNavigation;
	}
...
//		return this.getUnimAssetsNavigation()==null?null:this.getUnimAssetsNavigation().getMapNavId();
//	}
//	
//	/**
...
//	    if (aValue==null) {
//	    	unimAssetsNavigation = null;
//	    } else if (unimAssetsNavigation == null) {
//	        unimAssetsNavigation = new com.ulane.monitor.model.unim.UnimAssetsNavigation(aValue);
//	        unimAssetsNavigation.setVersion(new Integer(0));//set a version to cheat hibernate only
//	    } else {
//	    	//
//			unimAssetsNavigation.setMapNavId(aValue);
//	    }
//	}	
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnimAssetsMap other = (UnimAssetsMap) obj;
		if (address == null) {
		...
		if (unimAssetsNavigation == null) {
			if (other.unimAssetsNavigation != null)
				return false;
		} else if (!unimAssetsNavigation.equals(other.unimAssetsNavigation))
			return false;
		if (width == null) {
			if (other.width != null)
				return false;
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((unimAssetsNavigation == null) ? 0 : unimAssetsNavigation
						.hashCode());
