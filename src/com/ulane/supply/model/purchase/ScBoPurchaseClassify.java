...
/**
 * ScBoPurchaseClassify Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScBoPurchaseClassify extends com.htsoft.core.model.BaseModel {
	...
	protected com.ulane.supply.model.purchase.ScBoPurchaseDetail scBoPurchaseDetail;


	/**
	 * Default Empty Constructor for class ScBoPurchaseClassify
	 */
	public ScBoPurchaseClassify () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScBoPurchaseClassify
	 */
	public ScBoPurchaseClassify (
	...
	public com.ulane.supply.model.purchase.ScBoPurchaseDetail getScBoPurchaseDetail () {
		return scBoPurchaseDetail;
	}	
	
	public void setScBoPurchaseDetail (com.ulane.supply.model.purchase.ScBoPurchaseDetail in_scBoPurchaseDetail) {
		this.scBoPurchaseDetail = in_scBoPurchaseDetail;
	}
	...
	public Long getBizOrderDetailId() {
		return this.getScBoPurchaseDetail()==null?null:this.getScBoPurchaseDetail().getBizOrderDetailId();
	}
	...
	public void setBizOrderDetailId(Long aValue) {
	    if (aValue==null) {
	    	scBoPurchaseDetail = null;
	    } else if (scBoPurchaseDetail == null) {
	        scBoPurchaseDetail = new com.ulane.supply.model.purchase.ScBoPurchaseDetail(aValue);
	        scBoPurchaseDetail.setVersion(new Integer(0));//set a version to cheat hibernate only
	    } else {
	    	//
			scBoPurchaseDetail.setBizOrderDetailId(aValue);
	    }
	}	
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScBoPurchaseClassify)) {
			return false;
		}
		ScBoPurchaseClassify rhs = (ScBoPurchaseClassify) object;
