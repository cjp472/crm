package com.ulane.supply.model.purchase;
/*
...
/**
 * ScBoPurchaseDetail Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScBoPurchaseDetail extends com.htsoft.core.model.BaseModel {

    protected Long bizOrderDetailId;
	protected java.math.BigDecimal productUnitPrice;
	...
	protected com.ulane.supply.model.purchase.ScBizOrderPurchase scBizOrderPurchase;
	protected com.ulane.supply.model.goods.ScGoods scGoods;
	protected com.ulane.supply.model.stock.ScWarehouse scWarehouse;

	protected java.util.Set scBoPurchaseClassifys = new java.util.HashSet();
	protected java.util.Set scBoPurchaseDetailProInsts = new java.util.HashSet();

	/**
	 * Default Empty Constructor for class ScBoPurchaseDetail
	 */
	public ScBoPurchaseDetail () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScBoPurchaseDetail
	 */
	public ScBoPurchaseDetail (
	...
	public com.ulane.supply.model.purchase.ScBizOrderPurchase getScBizOrderPurchase () {
		return scBizOrderPurchase;
	}	
	
	public void setScBizOrderPurchase (com.ulane.supply.model.purchase.ScBizOrderPurchase in_scBizOrderPurchase) {
		this.scBizOrderPurchase = in_scBizOrderPurchase;
	}
	...
	public java.util.Set getScBoPurchaseClassifys () {
		return scBoPurchaseClassifys;
	}	
	
	public void setScBoPurchaseClassifys (java.util.Set in_scBoPurchaseClassifys) {
		this.scBoPurchaseClassifys = in_scBoPurchaseClassifys;
	}
	...
	public Long getBizOrderId() {
		return this.getScBizOrderPurchase()==null?null:this.getScBizOrderPurchase().getBizOrderId();
	}
	...
	public void setBizOrderId(Long aValue) {
	    if (aValue==null) {
	    	scBizOrderPurchase = null;
	    } else if (scBizOrderPurchase == null) {
	        scBizOrderPurchase = new com.ulane.supply.model.purchase.ScBizOrderPurchase(aValue);
	        scBizOrderPurchase.setVersion(new Integer(0));//set a version to cheat hibernate only
	    } else {
	    	//
			scBizOrderPurchase.setBizOrderId(aValue);
	    }
	}	
	...
	/**
	 * 产品价格	 * @return java.math.BigDecimal
	 * @hibernate.property column="PRODUCT_UNIT_PRICE" type="java.math.BigDecimal" length="15" not-null="false" unique="false"
	 */
	public java.math.BigDecimal getProductUnitPrice() {
		return this.productUnitPrice;
	}
	
	/**
	 * Set the productUnitPrice
	 */	
	public void setProductUnitPrice(java.math.BigDecimal aValue) {
		this.productUnitPrice = aValue;
	}	

	/**
	 * 产品数量	 * @return Long
	 * @hibernate.property column="PRODUCT_COUNT" type="java.lang.Long" length="15" not-null="false" unique="false"
	 */
	...
	/**
	 * Set the productCount
	 */	
	public void setProductCount(Long aValue) {
		this.productCount = aValue;
	}	

	/**
	 * 折前小计	 * @return java.math.BigDecimal
	 * @hibernate.property column="DISCOUNT_FORE_SUBTOTAL" type="java.math.BigDecimal" length="15" not-null="false" unique="false"
	 */
	...
	/**
	 * 折扣	 * @return String
	 * @hibernate.property column="DISCOUNT" type="java.lang.String" length="8" not-null="false" unique="false"
	 */
	 ...
	 * @hibernate.property column="CHANGED_AMOUNT" type="java.math.BigDecimal" length="15" not-null="false" unique="false"
	 */
	 ...
	 * @hibernate.property column="DISCOUNT_AFTER_SUBTOTAL" type="java.math.BigDecimal" length="15" not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScBoPurchaseDetail)) {
			return false;
		}
		ScBoPurchaseDetail rhs = (ScBoPurchaseDetail) object;
		return new EqualsBuilder()
				.append(this.bizOrderDetailId, rhs.bizOrderDetailId)
										.append(this.productUnitPrice, rhs.productUnitPrice)
				.append(this.productCount, rhs.productCount)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.bizOrderDetailId) 
										.append(this.productUnitPrice) 
				.append(this.productCount) 
				.append(this.discountForeSubtotal) 
				.append(this.discount) 
				.append(this.changedAmount) 
				.append(this.discountAfterSubtotal) 
				.append(this.desc) 
				.append(this.ext1) 
				.append(this.ext2) 
				.append(this.ext3) 
	...
	public String toString() {
		return new ToStringBuilder(this)
				.append("bizOrderDetailId", this.bizOrderDetailId) 
										.append("productUnitPrice", this.productUnitPrice) 
				.append("productCount", this.productCount) 
