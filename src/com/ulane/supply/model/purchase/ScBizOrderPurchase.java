...
/**
 * ScBizOrderPurchase Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScBizOrderPurchase extends com.htsoft.core.model.BaseModel {
	...
	protected Long purUserId;
	protected String purDeptId;
	...
	protected Short purchaseModelType;
	...
	/**
	 * Default Empty Constructor for class ScBizOrderPurchase
	 */
	public ScBizOrderPurchase () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScBizOrderPurchase
	 */
	public ScBizOrderPurchase (
		 Long in_bizOrderId
        ) {
	...
	/**
	 * 应发生总数量	 * @return Long
	 * @hibernate.property column="TOTAL_COUNT" type="java.lang.Long" length="15" not-null="false" unique="false"
	 */
	...
	/**
	 * 已发生数量	 * @return Long
	 * @hibernate.property column="FACT_TOTAL_COUNT" type="java.lang.Long" length="15" not-null="true" unique="false"
	 */
	...
	/**
	 * 创建用户部门内码	 * @return String
	 * @hibernate.property column="CREATE_DEPT_ID" type="java.lang.String" length="8" not-null="false" unique="false"
	 */
	 ...
	 */	
	public void setCreateDeptId(String aValue) {
		this.createDeptId = aValue;
	}	

	/**
	 * 采购用户内码	 * @return Long
	 * @hibernate.property column="PUR_USER_ID" type="java.lang.Long" length="18" not-null="false" unique="false"
	 */
	 ...
	 * Set the purUserId
	 */	
	public void setPurUserId(Long aValue) {
		this.purUserId = aValue;
	}	

	/**
	 * 采购用户部门内码	 * @return String
	 * @hibernate.property column="PUR_DEPT_ID" type="java.lang.String" length="8" not-null="false" unique="false"
	 */
	 ...
	 * Set the purDeptId
	 */	
	public void setPurDeptId(String aValue) {
		this.purDeptId = aValue;
	}	
	...
	/**
	 * 采购模式：0--买断模式，1--铺货代销模式&CON_T_PUR_MODEL	 * @return Short
	 * @hibernate.property column="PURCHASE_MODEL_TYPE" type="java.lang.Short" length="5" not-null="false" unique="false"
	 */
	public Short getPurchaseModelType() {
		return this.purchaseModelType;
	}
	
	/**
	 * Set the purchaseModelType
	 */	
	public void setPurchaseModelType(Short aValue) {
		this.purchaseModelType = aValue;
	}	
	 ...
	 * @hibernate.property column="BIZ_ORDER_SUB_STATUS" type="java.lang.Short" length="5" not-null="true" unique="false"
	 */
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScBizOrderPurchase)) {
			return false;
		}
		ScBizOrderPurchase rhs = (ScBizOrderPurchase) object;
		return new EqualsBuilder()
				...
				.append(this.purUserId, rhs.purUserId)
				.append(this.purDeptId, rhs.purDeptId)
				...
				.append(this.purchaseModelType, rhs.purchaseModelType)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				...
				.append(this.purUserId) 
				.append(this.purDeptId) 
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("purUserId", this.purUserId) 
				.append("purDeptId", this.purDeptId) 
				...
				.append("purchaseModelType", this.purchaseModelType) 
