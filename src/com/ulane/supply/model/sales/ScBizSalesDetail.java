...
/**
 * ScBizSalesDetail Base Java Bean, base class for the.base.model, mapped
 ...
 * 
 */
public class ScBizSalesDetail extends com.htsoft.core.model.BaseModel {

	protected Long bizOrderDetailId;
	protected java.math.BigDecimal goodsUnitPrice;
	protected Long goodsCount;
	protected java.math.BigDecimal discountForeSubtotal;
	protected String discount;
	protected java.math.BigDecimal changedAmount;
	protected java.math.BigDecimal discountAfterSubtotal;
	public Long scgoodsId;
	protected String detallDesc;
	...
	protected com.ulane.supply.model.sales.ScBizOrderSales scBizOrderSales;
	protected com.ulane.supply.model.goods.ScGoods scGoods;
	protected com.ulane.supply.model.stock.ScWarehouse scWarehouse;

	protected java.util.Set scBizSalesClassifys = new java.util.HashSet();
	protected java.util.Set scBoSalesDetailProInsts = new java.util.HashSet();

	/**
	 * Default Empty Constructor for class ScBizSalesDetail
	 */
	public ScBizSalesDetail() {
		super();
	}

	/**
	 * Default Key Fields Constructor for class ScBizSalesDetail
	 */
	public ScBizSalesDetail(Long in_bizOrderDetailId) {
		this.setBizOrderDetailId(in_bizOrderDetailId);
	}

	public com.ulane.supply.model.sales.ScBizOrderSales getScBizOrderSales() {
		return scBizOrderSales;
	}

	public void setScBizOrderSales(
			com.ulane.supply.model.sales.ScBizOrderSales in_scBizOrderSales) {
		this.scBizOrderSales = in_scBizOrderSales;
	}
	...
	public void setScWarehouse(
			com.ulane.supply.model.stock.ScWarehouse in_scWarehouse) {
		this.scWarehouse = in_scWarehouse;
	}

	public java.util.Set getScBizSalesClassifys() {
		return scBizSalesClassifys;
	}

	public void setScBizSalesClassifys(java.util.Set in_scBizSalesClassifys) {
		this.scBizSalesClassifys = in_scBizSalesClassifys;
	}
	...
	public void setScBoSalesDetailProInsts(
			java.util.Set in_scBoSalesDetailProInsts) {
	 ...
	 * 业务单明细内码 * @return Long
	 * 
	 * @hibernate.id column="BIZ_ORDER_DETAIL_ID" type="java.lang.Long"
	...
	public Long getBizOrderId() {
		return this.getScBizOrderSales() == null ? null : this
				.getScBizOrderSales().getBizOrderId();
	}
	...
	public void setBizOrderId(Long aValue) {
		if (aValue == null) {
			scBizOrderSales = null;
		} else if (scBizOrderSales == null) {
			scBizOrderSales = new com.ulane.supply.model.sales.ScBizOrderSales(
					aValue);
			scBizOrderSales.setVersion(new Integer(0));// set a version to cheat
														// hibernate only
		} else {
			//
			scBizOrderSales.setBizOrderId(aValue);
		}
	}
	...
	public Long getWarehouseId() {
		return this.getScWarehouse() == null ? null : this.getScWarehouse()
				.getWarehouseId();
	}
	...
	public void setWarehouseId(Long aValue) {
		if (aValue == null) {
			...
			scWarehouse.setVersion(new Integer(0));// set a version to cheat
													// hibernate only
		} else {
			//
	...
	public Long getGoodsId() {
		return this.getScGoods() == null ? null : this.getScGoods()
				.getGoodsId();
	}
	...
	public void setGoodsId(Long aValue) {
		if (aValue == null) {
			...
			scGoods.setVersion(new Integer(0));// set a version to cheat
												// hibernate only
		} else {
			//
	 ...
	 * 
	 * @hibernate.property column="GOODS_UNIT_PRICE" type="java.math.BigDecimal"
	 ...
	 *                     not-null="false" unique="false"
	 */
	public String getDetallDesc() {
		return detallDesc;
	}

	public void setDetallDesc(String detallDesc) {
		this.detallDesc = detallDesc;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScBizSalesDetail)) {
			return false;
		}
		ScBizSalesDetail rhs = (ScBizSalesDetail) object;
		return new EqualsBuilder()
				...
				.append(this.discountForeSubtotal, rhs.discountForeSubtotal)
				.append(this.discount, rhs.discount)
				.append(this.changedAmount, rhs.changedAmount)
				.append(this.discountAfterSubtotal, rhs.discountAfterSubtotal)
				.append(this.detallDesc, rhs.detallDesc)
				.append(this.ext1, rhs.ext1).append(this.ext2, rhs.ext2)
				.append(this.ext3, rhs.ext3).append(this.ext4, rhs.ext4)
				.append(this.ext5, rhs.ext5).append(this.ext6, rhs.ext6)
				.append(this.ext7, rhs.ext7).append(this.ext8, rhs.ext8)
				.append(this.ext9, rhs.ext9).append(this.ext10, rhs.ext10)
				.append(this.ext11, rhs.ext11).append(this.ext12, rhs.ext12)
				.append(this.ext13, rhs.ext13).append(this.ext14, rhs.ext14)
				.append(this.ext15, rhs.ext15).append(this.ext16, rhs.ext16)
				.append(this.ext17, rhs.ext17).append(this.ext18, rhs.ext18)
				.append(this.ext19, rhs.ext19).append(this.ext20, rhs.ext20)
				.isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.bizOrderDetailId).append(this.goodsUnitPrice)
				.append(this.goodsCount).append(this.discountForeSubtotal)
				.append(this.discount).append(this.changedAmount)
				.append(this.discountAfterSubtotal).append(this.detallDesc)
				.append(this.ext1).append(this.ext2).append(this.ext3)
				.append(this.ext4).append(this.ext5).append(this.ext6)
				.append(this.ext7).append(this.ext8).append(this.ext9)
				.append(this.ext10).append(this.ext11).append(this.ext12)
				.append(this.ext13).append(this.ext14).append(this.ext15)
				.append(this.ext16).append(this.ext17).append(this.ext18)
				.append(this.ext19).append(this.ext20).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("desc", this.detallDesc).append("ext1", this.ext1)
				...
				.append("ext20", this.ext20).toString();
	}
