...
/**
 * ScBizSalesClassify Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScBizSalesClassify extends com.htsoft.core.model.BaseModel {

    protected Long bizOrderDetailClassifyId;
	protected String classifyDesc;
	...
	protected com.ulane.supply.model.sales.ScBizSalesDetail scBizSalesDetail;


	/**
	 * Default Empty Constructor for class ScBizSalesClassify
	 */
	public ScBizSalesClassify () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScBizSalesClassify
	 */
	public ScBizSalesClassify (
		 Long in_bizOrderDetailClassifyId
        ) {
		this.setBizOrderDetailClassifyId(in_bizOrderDetailClassifyId);
    }

	
	public com.ulane.supply.model.sales.ScBizSalesDetail getScBizSalesDetail () {
		return scBizSalesDetail;
	}	
	
	public void setScBizSalesDetail (com.ulane.supply.model.sales.ScBizSalesDetail in_scBizSalesDetail) {
		this.scBizSalesDetail = in_scBizSalesDetail;
	}
    

	/**
	 * 业务单明细分类内码	 * @return Long
     * @hibernate.id column="BIZ_ORDER_DETAIL_CLASSIFY_ID" type="java.lang.Long" generator-class="native"
	 */
	public Long getBizOrderDetailClassifyId() {
		return this.bizOrderDetailClassifyId;
	}
	
	/**
	 * Set the bizOrderDetailClassifyId
	 */	
	public void setBizOrderDetailClassifyId(Long aValue) {
		this.bizOrderDetailClassifyId = aValue;
	}	
	...
	public Long getBizOrderDetailId() {
		return this.getScBizSalesDetail()==null?null:this.getScBizSalesDetail().getBizOrderDetailId();
	}
	...
	public void setBizOrderDetailId(Long aValue) {
	    if (aValue==null) {
	    	scBizSalesDetail = null;
	    } else if (scBizSalesDetail == null) {
	        scBizSalesDetail = new com.ulane.supply.model.sales.ScBizSalesDetail(aValue);
	        scBizSalesDetail.setVersion(new Integer(0));//set a version to cheat hibernate only
	    } else {
	    	//
			scBizSalesDetail.setBizOrderDetailId(aValue);
	    }
	}	
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScBizSalesClassify)) {
			return false;
		}
		ScBizSalesClassify rhs = (ScBizSalesClassify) object;
		return new EqualsBuilder()
				.append(this.bizOrderDetailClassifyId, rhs.bizOrderDetailClassifyId)
						.append(this.classifyDesc, rhs.classifyDesc)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.bizOrderDetailClassifyId) 
						.append(this.classifyDesc) 
				.append(this.ext1) 
				.append(this.ext2) 
				.append(this.ext3) 
				.append(this.ext4) 
	...
	public String toString() {
		return new ToStringBuilder(this)
				.append("bizOrderDetailClassifyId", this.bizOrderDetailClassifyId) 
						.append("desc", this.classifyDesc) 
