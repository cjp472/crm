...
/**
 * ScGoodsPriceVersion Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScGoodsPriceVersion extends com.htsoft.core.model.BaseModel {
	...
	/**
	 * Default Empty Constructor for class ScGoodsPriceVersion
	 */
	public ScGoodsPriceVersion () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScGoodsPriceVersion
	 */
	public ScGoodsPriceVersion (
		 Long in_goodsPriceId
        ) {
	...
	/**
	 * 商品价目内码	 * @return Long
     * @hibernate.id column="GOODS_PRICE_ID" type="java.lang.Long" generator-class="native"
	 */
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScGoodsPriceVersion)) {
			return false;
		}
		ScGoodsPriceVersion rhs = (ScGoodsPriceVersion) object;
		return new EqualsBuilder()
				.append(this.goodsPriceId, rhs.goodsPriceId)
