...
/**
 * ScPurpriceVersion Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ScPurpriceVersion extends com.htsoft.core.model.BaseModel {
	...
	/**
	 * Default Empty Constructor for class ScPurpriceVersion
	 */
	public ScPurpriceVersion () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class ScPurpriceVersion
	 */
	public ScPurpriceVersion (
		 Long in_purPriceId
        ) {
	...
	public void setScPurchasePriceGoodss (java.util.Set in_scPurchasePriceGoodss) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof ScPurpriceVersion)) {
			return false;
		}
		ScPurpriceVersion rhs = (ScPurpriceVersion) object;
