...
/**
 * CtScrQue Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class CtScrQue extends com.htsoft.core.model.BaseModel {
	...
	protected java.util.Set ctScrCats = new java.util.HashSet();
	protected java.util.Set ctScrQueOpts = new java.util.HashSet();
	...
	/**
	 * Default Empty Constructor for class CtScrQue
	 */
	public CtScrQue () {
		super();
	}
	...
	/**
	 * Default Key Fields Constructor for class CtScrQue
	 */
	public CtScrQue (
		 Long in_queId
        ) {
	...
	public java.util.Set getCtScrCats () {
		return ctScrCats;
	}	
	
	public void setCtScrCats (java.util.Set in_ctScrCats) {
		this.ctScrCats = in_ctScrCats;
	}

	public java.util.Set getCtScrQueOpts () {
		return ctScrQueOpts;
	}	
	
	public void setCtScrQueOpts (java.util.Set in_ctScrQueOpts) {
		this.ctScrQueOpts = in_ctScrQueOpts;
	}
	...
	/**
	 * 题目类型：单选题、多选题、是非题、问答题&CT_TMLX	 * @return Short
	...
	/**
	 * 展现方式：下拉选择、展开选择&CT_ZXFS	 * @return Short
	...
	/**
	 * 显示尺寸：长中短，对应配置&CT_XSCC	 * @return Short
	...
	/**
	 * 选项来源：手动、系统参数&CT_XXLY	 * @return Short
	...
	public boolean equals(Object object) {
		if (!(object instanceof CtScrQue)) {
			return false;
		}
		CtScrQue rhs = (CtScrQue) object;
