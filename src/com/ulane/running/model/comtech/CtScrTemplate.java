...
/**
 * CtScrTemplate Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
...
public class CtScrTemplate extends com.htsoft.core.model.BaseModel {
	...
	protected java.util.Set ctScrChapcters = new java.util.HashSet();
	protected java.util.Set ctScrReleases = new java.util.HashSet();
	protected java.util.Set ctScrTemGotoRules = new java.util.HashSet();
	...
	/**
	 * Default Empty Constructor for class CtScrTemplate
	 */
	public CtScrTemplate () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class CtScrTemplate
	 */
	public CtScrTemplate (
		 Long in_tmpId
        ) {
	...
	public java.util.Set getCtScrChapcters () {
		return ctScrChapcters;
	}	
	
	public void setCtScrChapcters (java.util.Set in_ctScrChapcters) {
		this.ctScrChapcters = in_ctScrChapcters;
	}

	public java.util.Set getCtScrReleases () {
		return ctScrReleases;
	}	
	
	public void setCtScrReleases (java.util.Set in_ctScrReleases) {
		this.ctScrReleases = in_ctScrReleases;
	}

	public java.util.Set getCtScrTemGotoRules () {
		return ctScrTemGotoRules;
	}	
	
	public void setCtScrTemGotoRules (java.util.Set in_ctScrTemGotoRules) {
		this.ctScrTemGotoRules = in_ctScrTemGotoRules;
	}
	...
	/**
	 * 展示布局：全部展示、按树展示、按标签展示&CT_HSZSBJ	 * @return Short
	...
	/**
	 * 展示样式：按跳题展示、全部展示、展示当前题目&CT_ZSYS	 * @return Short
	...
	public boolean equals(Object object) {
		if (!(object instanceof CtScrTemplate)) {
			return false;
		}
		CtScrTemplate rhs = (CtScrTemplate) object;
