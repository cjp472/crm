...
/**
 * PapCat Base Java Bean, base class for the.base.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class PapCat extends com.htsoft.core.model.BaseModel {
	...
	protected java.util.Set<PapQue> papQues = new java.util.HashSet<PapQue>();

	/**
	 * Default Empty Constructor for class PapCat
	 */
	public PapCat () {
		super();
	}
	...
	/**
	 * Default Key Fields Constructor for class PapCat
	 */
	public PapCat (
		 Long in_queCatId
        ) {
	...
	public java.util.Set<PapQue> getPapQues () {
		return papQues;
	}	
	
	public void setPapQues (java.util.Set<PapQue> in_papCatQues) {
		this.papQues = in_papCatQues;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof PapCat)) {
			return false;
		}
		PapCat rhs = (PapCat) object;
		return new EqualsBuilder()
				.append(this.queCatId, rhs.queCatId)
				.append(this.parQueCatId, rhs.parQueCatId)
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("parQueCatId", this.parQueCatId) 
