...
public class FlowUtil {
	...
	public static String  getPrimaryKeyByEntity(String EntityName){
		...
		String hbmDirPath = rootPath + "WEB-INF/classes/com/htsoft/oa/model/process";
	...
	public static DynaModel getInitDynModel(String entityName){
		...
		DynaModel model=new DynaModel(entityName);
		//提高性能时可以考虑放至缓存中TODO
		String entityHbmFile=AppUtil.getAppAbsolutePath()+"/WEB-INF/classes/com/htsoft/oa/model/process/"+entityName+".hbm.xml";
		Document doc=XmlUtil.load(entityHbmFile);
