...
//	protected Short parentId;
	...
	@Expose
	protected Short relaOperation;
	@Expose
	protected Long relDic;
	@Expose
	protected Long relType;
	@Expose
	protected Dictionary relDictionary;
	@Expose
	protected GlobalType relGlobalType;

	protected java.util.Set ukDimensionalityKnows = new java.util.HashSet();
	
//    public Long getParentId() {
//        return parent!=null?parent.getDicId():null;
//    }
//
...
//            parent = null;
//        } else if (parent == null) {
//            parent = new Dictionary(parentId);
//            
//        } else {
//            parent.setDicId(parentId);
//        }
//    }
	...
	public Long getRelDic() {
		return relDic;
	}
	
	public void setRelDic(Long relDic) {
		this.relDic = relDic;
	}
	...
	public Dictionary getRelDictionary() {
		return relDictionary;
	}

	public void setRelDictionary(Dictionary relDictionary) {
		this.relDictionary = relDictionary;
	}

	public GlobalType getRelGlobalType() {
		return relGlobalType;
	}

	public void setRelGlobalType(GlobalType relGlobalType) {
		this.relGlobalType = relGlobalType;
	}

	public Short getRelaOperation() {
		return relaOperation;
	}
	
	public void setRelaOperation(Short relaOperation) {
...
//	}
	...
	/**
	 * @return String
	 * @hibernate.property column="itemIndex" type="java.lang.String" length="128" not-null="true" unique="false"
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder()
				...
				.append(this.itemIndex, rhs.itemIndex)
//				.append(this.parentId, rhs.parentId)
				.append(this.statusId, rhs.statusId)
				.append(this.relaOperation, rhs.relaOperation)
				.append(this.relDic, rhs.relDic)
...
//				.append(this.parentId)
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("itemIndex",this.itemIndex)
//				.append("parentId",this.parentId)
				.append("statusId",this.statusId)
				.append("relaOperation",this.relaOperation)
				.append("relDic",this.relDic)
