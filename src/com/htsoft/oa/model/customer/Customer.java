...
public class Customer extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	protected Short isMail;   //1显示，0不显示
	@Expose
	protected Short isDm;     //1显示，0不显示
	@Expose
	protected Short happyCall;  //1显示，0不显示
	@Expose
	protected Short cusType;  //1=个人客户，2=企业客户

	private java.util.Set<CusLinkman> cusLinkmans = new java.util.HashSet<CusLinkman>();

	private java.util.Set<Project> projects = new java.util.HashSet<Project>();

	private java.util.Set<CusConnection> cusConnections = new java.util.HashSet<CusConnection>();
	
	protected java.util.Set<CusContact> cusContacts = new java.util.HashSet<CusContact>();
	
	protected java.util.Set<CusRelationship> customerRels = new java.util.HashSet<CusRelationship>();
	/**
	...
	public java.util.Set<CusContact> getCusContacts() {
        return cusContacts;
    }

    public void setCusContacts(java.util.Set<CusContact> cusContacts) {
        this.cusContacts = cusContacts;
    }

    @SuppressWarnings("unused")
    private java.util.Set<CusLinkman> getCusLinkmans () {
		return cusLinkmans;
	}	
	
    @SuppressWarnings("unused")
    private void setCusLinkmans (java.util.Set<CusLinkman> in_cusLinkmans) {
		this.cusLinkmans = in_cusLinkmans;
	}
    

    @SuppressWarnings("unused")
    private java.util.Set<Project> getProjects() {
		return projects;
	}

    @SuppressWarnings("unused")
    private void setProjects(java.util.Set<Project> projects) {
		this.projects = projects;
	}

    @SuppressWarnings("unused")
    private java.util.Set<CusConnection> getCusConnections() {
		return cusConnections;
	}

    @SuppressWarnings("unused")
    private void setCusConnections(java.util.Set<CusConnection> cusConnections) {
		this.cusConnections = cusConnections;
	}

	public java.util.Set<CusRelationship> getCustomerRels() {
		return customerRels;
	}

	public void setCustomerRels(java.util.Set<CusRelationship> customerRels) {
		this.customerRels = customerRels;
	}
	...
	public Short getIsDm() {
		return isDm;
	}

	public void setIsDm(Short isDm) {
		this.isDm = isDm;
	}

	public Short getHappyCall() {
		return happyCall;
	}

	public void setHappyCall(Short happyCall) {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder()
				...
				.append(this.isMail, rhs.isMail)
				.append(this.isDm, rhs.isDm)
				.append(this.happyCall, rhs.happyCall)
				.append(this.cusType, rhs.cusType)
				.isEquals();
	}
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("isDm", this.isDm)
				.append("happyCall", this.happyCall)
				.append("cusType", this.cusType)
				.toString();
	}
