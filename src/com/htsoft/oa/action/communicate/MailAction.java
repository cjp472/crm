...
public class MailAction extends BaseAction {
	...
	public String search() {
		...
		String uploadPath = getSession().getServletContext().getRealPath("/attachFiles/indexDir/");
		System.out.println("/attachFiles/indexDir/::::"+uploadPath);
		List<MailBox> list = mailBoxService.findBySearch(searchContent, pb ,uploadPath);
		Gson gson = new Gson();
		StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
